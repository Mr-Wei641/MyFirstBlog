...
@section('content')
<table id="table_id_cate" class="display">
    <thead>
        <tr>
            <th></th>
            <th>id</th>
    ...
    $('#table_id_cate').DataTable({
        ...
        "columnDefs":[{ 
            ...
            "render":function(data, type, row){
                return '<form action="/admin/cate/' + row.id +'" method="post">' +
                '<a href="/admin/cate/' + row.id +'/edit" title="修改">' + 
