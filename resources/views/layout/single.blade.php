...
<head>
    ...
    <!-- Font-Awesome -->
    <link rel="stylesheet" href={{asset("home/css/font-awesome/css/font-awesome.min.css")}}>

    <!-- Google Webfonts -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600|PT+Serif:400,400italic' rel='stylesheet' type='text/css'>

    <!-- Styles -->
    <link rel="stylesheet" href={{asset("home/css/style.css")}} id="theme-styles">

    <!--[if lt IE 9]>      
        <script src="home/js/vendor/google/html5-3.6-respond-1.1.0.min.js"></script>
    <![endif]-->
        ...
        <div class="widewrapper masthead">
            <div class="container">
                <a href="index.html" id="logo">
                    <img src={{asset("home/img/logo.png")}} alt="clean Blog">
                </a>
                    ...
                    <article class="blog-post">
                        <header>
                            ...
                            <div class="lead-image">
                                <img src="home/img/single-post.jpg" alt="" class="img-responsive">
                    ...
                    <aside class="comments" id="comments">
                        ...
                        <article class="comment">
                            <header class="clearfix">
                                <img src="home/img/avatar.png" alt="A Smart Guy" class="avatar">
                                <div class="meta">
